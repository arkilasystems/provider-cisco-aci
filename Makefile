...
PROJECT_NAME ?= provider-cisco-aci
...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/CiscoDevNet/terraform-provider-aci/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-aci_v$(TERRAFORM_PROVIDER_VERSION)
...
xpkg.build.provider-cisco-aci: do.build.images
